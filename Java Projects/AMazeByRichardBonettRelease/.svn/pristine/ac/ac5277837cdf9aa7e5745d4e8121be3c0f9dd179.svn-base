...
public class Constants {
	...
	static final String BUILDER_DEFAULT = "Falstad";
	static final String BUILDER_PRIM = "Prim";
	static final String BUILDER_KRUSKAL = "Kruskal";
	...
	static final int MAX_BATTERY_LEVEL = 2500;
	static int SLEEP_INTERVAL = 1000;
	static final int[] SLEEP_INTERVALS = {10, 25, 50, 100, 250, 500, 1000};
	
	static final int MOVE_FORWARD = 500;
	static final int MOVE_BACKWARD = 400;
	static final int ROTATE_LEFT = 300;
	static final int ROTATE_RIGHT = 200;
